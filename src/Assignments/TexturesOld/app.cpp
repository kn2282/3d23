...
auto texture_file = (std::string(ROOT_DIR) + "/Models/multicolor.png").c_str();
...
//    glBindBuffer(GL_ARRAY_BUFFER, 0);
    ...
    ColorMaterial redMaterial = ColorMaterial(glm::vec4(1.0f, 0.0f, 0.0f, 1.0f));
    ColorMaterial blueMaterial = ColorMaterial(glm::vec4(0.0f, 0.0f, 1.0f, 1.0f));
    ColorMaterial greenMaterial = ColorMaterial(glm::vec4(0.0f, 1.0f, 0.0f, 1.0f));
    ColorMaterial violetMaterial = ColorMaterial(glm::vec4(1.0f, 0.0f, 1.0f, 1.0f));
    ColorMaterial cyanMaterial = ColorMaterial(glm::vec4(0.0f, 1.0f, 1.0f, 1.0f));
    ColorMaterial brownMaterial = ColorMaterial(glm::vec4(1.0f, 1.0f, 0.0f, 1.0f));

    pyramid->add_submesh(0, 3, &redMaterial);
    pyramid->add_submesh(3, 9, &greenMaterial);
    pyramid->add_submesh(9, 12, &blueMaterial);
    pyramid->add_submesh(12, 15, &cyanMaterial);
    pyramid->add_submesh(15, 18, &brownMaterial);
    pyramid->add_submesh(18, 21, &violetMaterial);
    add_submesh(pyramid);
